...
def get_map_estimation_filepath(species,version,YYYY,MM,special_name):
    ...
    """
    outdir = Figure_outdir + '{}/{}/Map_Estimation/{}/'.format(species,version,YYYY)
...
def get_absolute_uncertainty_filepath(species,version,special_name,YYYY,MM,obs_version,nearby_sites_number):
    ...
    str: The constructed file path.
    """
    outdir = Figure_outdir + '{}/{}/Absolute_Uncertainty_Map/sitesnumber-{}/{}/'.format(species,version,nearby_sites_number,YYYY)
    if not os.path.exists(outdir):
        os.makedirs(outdir)
...
def get_mahalanobis_distance_filepath(species,version,YYYY,MM,obs_version,nearby_sites_number):
    ...
    str: The constructed file path.
    """
    outdir = Figure_outdir + '{}/{}/Mahalanobis_distance_Map/sitesnumber-{}/{}/'.format(species,version,nearby_sites_number,YYYY)
    if not os.path.exists(outdir):
        os.makedirs(outdir)
...
def get_rRMSE_uncertainty_filepath(species,version,YYYY,MM,obs_version,nearby_sites_number):
    ...
    str: The constructed file path.
    """
    outdir = Figure_outdir + '{}/{}/rRMSE_Map/sitesnumber-{}/{}/'.format(species,version,nearby_sites_number,YYYY)
    if not os.path.exists(outdir):
        os.makedirs(outdir)
